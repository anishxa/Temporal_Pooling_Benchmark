...
Applies a sliding-window segmentation to EDAIC utterance audio files,
...
Input:
    utterance_table_balanced.csv -- CSV with columns 'file_path' and 'label'
    pointing to the balanced EDAIC utterance audio files.

Output:
    <output_dir>/<parent>_<base>_seg<i>.wav -- Individual segment audio files.
    utterance_table_edaic_segmented.csv -- Metadata CSV with columns
...
# parameters
source_csv = "utterance_table_balanced.csv"
output_dir = "edaic_segments"
